...
class FUSEGANModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.set_defaults(norm='batch', netG='fuseGAN', dataset_mode='fusion')
        if is_train:
    ...
    def __init__(self, opt):
        ...
        self.loss_names = ['G_GAN', 'G_BCE', 'D_real', 'D_fake']
        ...
        if self.isTrain:
            ...
            self.criterionL1 = torch.nn.L1Loss()            # initialize optimizers; schedulers will be automatically created by function <BaseModel.setup>.
    ...
    def set_input(self, input):
        ...
        """
        ABtoF = self.opt.direction == 'ABtoF'
    ...
    def backward_G(self):
        ...
        # Second, G(A) = B
        self.real_F[self.real_F == -1] = 0
        self.loss_G_BCE = self.criterionBCE(self.fake_F, self.real_F) * self.opt.lambda_L1
        # combine loss and calculate gradients
